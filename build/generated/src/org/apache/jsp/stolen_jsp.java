...
public final class stolen_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tflag=0;\n");
      out.write("\tday=document.form1.day.value;\n");
      out.write("\tmonth=document.form1.month.value;\n");
      out.write("\tyear=document.form1.year.value;\n");
      out.write("\n");
      out.write("\tvar d= new Date(); \n");
      out.write("\tmyd=  d.getDate();\n");
      out.write("\tmym= d.getMonth();\n");
      out.write("\tmyy= d.getYear();\n");
      out.write("\n");
      out.write("\tmym = mym+1;\n");
      out.write("\tmyy= myy+1900;\n");
      out.write(" \n");
      out.write("\tif(document.form1.rno.value == \"\"){\n");
      out.write("\t\talert(\"Type Registration number \");\n");
      out.write("\t\tdocument.form1.rno.focus();\n");
      out.write("\t\treturn; \n");
      out.write("\t}\n");
      out.write("\n");
      out.write("\tif(document.form1.day.value == \"\"){\n");
      out.write("\t\talert(\"Type Day  number \");\n");
      out.write("\t\tdocument.form1.day.focus();\n");
      out.write("return; \n");
      out.write("}\n");
      out.write("\n");
      out.write("if(document.form1.month.value == \"\")\n");
      out.write("{\n");
      out.write("alert(\"Type Month number \");\n");
      out.write("document.form1.month.focus();\n");
      out.write("return; \n");
      out.write("}\n");
      out.write("\n");
      out.write("if(document.form1.year.value == \"\")\n");
      out.write("{\n");
      out.write("alert(\"Type Year  number \");\n");
      out.write("document.form1.year.focus();\n");
      out.write("return; \n");
      out.write("}\n");
      out.write("\n");
      out.write("\n");
      out.write("if(month<1 ||  month>12) flag=1;\n");
      out.write("\n");
      out.write("if(day>31 || year>myy) flag=1;\n");
      out.write("\n");
      out.write("if(year==myy &&   month>mym) flag=1;\n");
      out.write("\n");
      out.write("if(year==myy && month==mym && day>myd) flag=1;\n");
      out.write("\n");
      out.write("if((year%4==0 && year%100!=0) || year%400 == 0) \n");
      out.write("{\n");
      out.write("if(day>29) flag=1;\n");
      out.write("} else  {     if(day>28) flag=1;    }\n");
      out.write("\n");
      out.write("if(flag==1)\n");
      out.write("{\n");
      out.write("alert(\"Date Not correct\");\n");
      out.write("return;\n");
      out.write("}\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("action=\"stolen1.jsp\">\n");
      out.write("\n");
      out.write("<h1 align=\"center\"><u>STOLEN VEHICLE REGISTRATION</u></h1>\n");
      out.write("<p>Enter your T/R Number:\n");
      out.write("  <input type=text name=rno>\n");
      out.write("</p>\n");
      out.write("Enter date of theft:\n");
      out.write("Day :<input type=text name=day SIZE = 2 MAXLENGTH=2 > \n");
      out.write(" Month \n");
      out.write(" <input type=text name=month SIZE = 2 MAXLENGTH=2>\n");
      out.write("Year \n");
      out.write("<input type=text name=year SIZE = 4 MAXLENGTH=4><br>\n");
      out.write("Enter Place Of Theft:\n");
      out.write("<input type=\"text\" name=\"place\">\n");
      out.write("<p><input type=submit  value=\"Go\"\n");
      out.write("          onClick=\"check()\" align=\"middle\"></p>\n");
      out.write("<hr>\n");
      out.write("</form>\n");
      out.write("\n");
      out.write("    \n");
