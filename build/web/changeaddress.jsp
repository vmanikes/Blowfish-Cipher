...
{
alert("Register number not entered !");
...
<title>Change Of Registration</title>
...
<form name=form1 method=post action = "change.jsp">
 ...
 <h1 style="color:black"align="center"><u>Change Of Residence In Registration</u></h1>
<hr>
<table align="center">
<tr>
<th>Enter T/R Number</th>
<td><input type=text name=rno></td>
</tr>
<tr>
<th>Enter Previous Address</th>
<td><textarea cols=25 rows=8 name=pre></textarea></td>
</tr>
<tr>
<th>Enter The Changed Address</th>
<td><textarea cols=25 rows=8 name=changed></textarea></td>
</tr>
<tr>
