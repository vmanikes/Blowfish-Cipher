...
<div class="container">
  ...
  <article class="content">
    <h1>&nbsp;</h1>
     ...
     <form method="post" action="dreg.jsp" name="duplicate form">
<h1 align="center"><u>DUPLICATE REGISTRATION</u></h1>
<table align="center">
<tr>
<th>Enter Your Name As In Registration Form</th>
<td><input type="text" name="rnumber" id="rnumber"/></td>
</tr>
<tr>
